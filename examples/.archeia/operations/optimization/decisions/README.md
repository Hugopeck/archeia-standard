...
**Broad interpretation.** May capture ADR-style technical decisions, strategic decisions, design rulings, operating policy choices, or growth-program decisions as long as the decision remains local to the owning path. Scoped to the `operations/optimization` subtree.
...
**What belongs here:**
- Local decisions records scoped to this subtree.

...
**Broad interpretation.** May capture postmortem lessons, user-research takeaways, execution lessons, architectural lessons, or go-to-market findings, provided they are preserved as local learning rather than rewritten into current canonical truth. Scoped to the `growth/execution/experiments` subtree.
...
**What belongs here:**
- Local learnings records scoped to this subtree.

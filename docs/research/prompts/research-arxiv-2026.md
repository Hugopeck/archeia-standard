...
Use this prompt to instruct an agent to find, evaluate, and format new arXiv papers for addition to `docs/research/arxiv-ai-engineering-2026.md`. Run it whenever the bibliography feels stale or before a significant spec revision.

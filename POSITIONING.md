...
The Archeia Standard does not compete with harness engineering. It depends on it. This document pins where Archeia stops being downstream of that corpus and starts contributing its own answer as an **Agentic Operating System** (**AOS**) for software businesses.
...
Archeia answers the repository-level question the harness corpus leaves open: where does each artifact go in the in-repo knowledge-layer AOS for a software business or software project?
